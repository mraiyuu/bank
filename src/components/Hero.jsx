...
const Hero = () => (
  <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
    ...
    >
      ...
      <p className={`${styles.paragraph} max-h-[470px] mt-5`}>Our team of experts uses a methodology to identify the credit card most likely to fit youe needs. We examine annual percentage rates, annual fees.</p>
    </div>
